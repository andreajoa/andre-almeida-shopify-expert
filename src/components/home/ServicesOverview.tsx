...
const cards = [
  { key: "dev", Icon: ShoppingBag, color: "text-indigo-400", bg: "bg-indigo-500/10 border-indigo-500/20" },
  { key: "growth", Icon: TrendingUp, color: "text-emerald-400", bg: "bg-emerald-500/10 border-emerald-500/20" },
  { key: "design", Icon: Palette, color: "text-purple-400", bg: "bg-purple-500/10 border-purple-500/20" },
]
            ...
            <AnimatedSection key={key} delay={i * 0.15}>
              <Card variant="gradient" className="h-full group">
                ...
                <ul className="space-y-2">
                  {(t.raw(`${key}.f`) as string[]).map((f: string, j: number) => (
