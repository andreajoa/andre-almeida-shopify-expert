        ...
        <div className="grid lg:grid-cols-[1.04fr_0.96fr] gap-14 items-center">
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-3 mb-9 max-w-2xl">
              {[
                isPt ? "Para quem quer abrir uma loja virtual do zero" : "For new online stores",
                isPt ? "Para quem já vende, mas quer vender mais" : "For stores that want more sales",
                isPt ? "Para mercados, confeitarias e negócios locais" : "For local businesses and delivery",
                isPt ? "Para Shopify, tráfego, SEO e automação" : "For Shopify, traffic, SEO and automation",
              ].map((item) => (
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-5">
              ...
              >
                ...
                {isPt ? "Chamar no WhatsApp" : "Message me on WhatsApp"}
              </a>
              ...
              >
                {isPt ? "Ver soluções" : "View services"}
            ...
            <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { value: "6+", label: isPt ? "anos de experiência" : "years of experience" },
                { value: "100+", label: isPt ? "lojas e projetos" : "stores and projects" },
                { value: "15+", label: isPt ? "países atendidos" : "countries served" },
                { value: "Shopify", label: isPt ? "especialista" : "specialist" },
              ].map((stat) => (
            ...
            <div className="relative rounded-[2rem] border border-white/10 bg-white/[0.05] p-5 shadow-2xl backdrop-blur">
              <div className="rounded-3xl border border-white/10 bg-slate-950/90 p-5">
                <div className="flex items-center justify-between mb-5">
                  <div>
                    <p className="text-sm text-slate-400">{isPt ? "Diagnóstico da loja" : "Store diagnosis"}</p>
                    <h2 className="text-xl font-bold text-white">{isPt ? "Plano de crescimento" : "Growth plan"}</h2>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-5">
                  {[
                    { icon: ShoppingCart, label: isPt ? "Loja virtual" : "Online store", value: "Shopify" },
                    { icon: TrendingUp, label: isPt ? "Conversão" : "Conversion", value: "+ vendas" },
                    { icon: Zap, label: "Performance", value: "SEO + speed" },
                    { icon: Rocket, label: isPt ? "Escala" : "Scale", value: "Ads + IA" },
                ...
                <div className="rounded-2xl bg-gradient-to-r from-indigo-500/15 to-emerald-500/15 border border-white/10 p-5 mb-5">
                  <p className="text-sm text-slate-300 mb-3">
                    {isPt ? "O que eu identifico no diagnóstico:" : "What I check in the diagnosis:"}
                  </p>
                  <div className="space-y-3">
                    {[
                      isPt ? "Onde sua loja perde vendas" : "Where your store loses sales",
                      isPt ? "O que precisa melhorar no layout" : "What needs to improve in the layout",
                      isPt ? "Como atrair clientes pelo Google, IA e tráfego pago" : "How to attract customers from search, AI and ads",
                    ].map((item) => (
                ...
                >
                  {isPt ? "Quero meu diagnóstico" : "I want my diagnosis"}
                  <ArrowRight className="w-5 h-5" />
                </a>
              </div>
            </div>
