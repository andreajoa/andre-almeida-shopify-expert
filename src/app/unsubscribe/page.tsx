...
function Shell({ children }: { children: React.ReactNode }) {
  return <main className="min-h-screen bg-[#f2efe8] px-5 py-24 text-[#11110f] sm:px-8"><div className="mx-auto max-w-2xl border border-[#d4cec2] bg-[#fffdf8] p-8 sm:p-12">{children}</div></main>
}
...
export default function UnsubscribePage() {
  return <Suspense fallback={<Shell><p className="text-[10px] font-semibold uppercase tracking-[.2em] text-[#77736b]">ANDRÉ ALMEIDA · EMAIL</p><h1 className="mt-7 font-editorial text-5xl leading-[.95] tracking-[-.04em] sm:text-6xl">Processando...</h1></Shell>}><UnsubscribeContent /></Suspense>
}
