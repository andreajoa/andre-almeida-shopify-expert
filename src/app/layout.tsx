...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return <html lang="pt-BR" className={`${inter.variable} ${editorial.variable}`}><body className={inter.className}><GoogleAnalytics /><VisitorTracker />{children}<LeadCapture /></body></html>
}
